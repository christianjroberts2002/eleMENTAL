...
Shader "AmplifyShaderPack/Material Sample Specular"
{
	...
	SubShader
	{
		...
		{
			float2 temp_output_133_0_g5 = ( ( i.uv_texcoord * (_MainUVs).xy ) + (_MainUVs).zw );
			o.Normal = UnpackScaleNormal( tex2D( _BumpMap, temp_output_133_0_g5 ), _NormalStrength );
			...
			o.Albedo = temp_output_89_0_g5;
			float3 temp_output_202_0_g5 = (_SpecularColor).rgb;
			o.Specular = ( temp_output_202_0_g5 * (tex2D( _SpecularMap, temp_output_133_0_g5 )).rgb * _SpecularStrength );
			o.Smoothness = ( _SmoothnessStrength * (tex2D( _SmoothnessMap, temp_output_133_0_g5 )).rgb ).x;
			o.Occlusion = saturate( ( ( 1.0 - _OcclusionStrengthAO ) * (tex2D( _OcclusionMap, temp_output_133_0_g5 )).rgb ) ).x;
			o.Alpha = 1;
		}
...
WireConnection;0;1;13;6
WireConnection;0;3;13;5
WireConnection;0;4;13;2
WireConnection;0;5;13;4
ASEEND*/
//CHKSM=0220E8346047C7016448A988F7097D64D07B2B1C